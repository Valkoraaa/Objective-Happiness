...
Assigne un métier à un habitant, ou converti un habitant (cliquer sur le personnage puis sur l'école pour choisir le métier).

• Ferme :

Donne 100 de nourriture à sa construction.

• Librairie : 

Donne 40 p de prospérité à sa construction.
...
Récolte X de nourriture/jour dans la zone Buissons.

• Bûcheron : 

Récolte X de bois/jour dans la zone Forêt.

• Mineur : 

Récolte X de pierre/jour dans la zone Pierres.

• Maçon : 

Construit les bâtiment. Ne peut être que sur 1 chantier à la fois/jour.
